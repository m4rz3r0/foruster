...
- **Linux** uses `O_NOATIME` when opening files for format sniffing where the kernel and permissions allow, with fallback to normal open if `EPERM`.
...
- [HASH_SETS.md](HASH_SETS.md) — hash database layout under `data/hashsets/`.
- [PLUGIN_SDK.md](PLUGIN_SDK.md) — host I/O limits for plugins.
- [INDEX.md](INDEX.md) — plugin and packaging documentation index.
