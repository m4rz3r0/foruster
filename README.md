...
This repository provides **documentation** and **release binaries** for **Foruster**. **Application source code is not published here.** The **project site** (**https://m4rz3r0.github.io/foruster/**) is the usual entry point: **latest downloads** without using the GitHub interface, plus links into the full guides. Guides and release assets are also listed under [`doc/en/`](doc/en/README.md) / [`doc/es/`](doc/es/README.md) and [Releases](https://github.com/m4rz3r0/foruster/releases). Enable Pages with *Settings → Pages → branch `main`, folder `/docs`*.
...
**Foruster** is **proprietary, closed-source software** as distributed to licensees or customers. Documentation in this repository is published for reference; third-party components remain under their respective licenses. The terms that apply to materials in this repository are in **[LICENSE](LICENSE)**. Do not infer from this README alone how any particular binary build is licensed; check the notice shipped with that build.
