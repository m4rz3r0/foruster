<div align="center">
  <p align="center">
    <img src="assets/brand/complete.svg" alt="Foruster" width="280">
  </p>
...
Este repositorio ofrece la **documentación** y los **binarios publicados** de **Foruster**. **El código fuente de la aplicación no se publica aquí.** El **sitio del proyecto** (**https://m4rz3r0.github.io/foruster/**) es la entrada habitual: **últimas descargas** sin usar la interfaz de GitHub, más enlaces a las guías completas. Las guías y los binarios también figuran en [`doc/en/`](doc/en/README.md) / [`doc/es/`](doc/es/README.md) y en [Releases](https://github.com/m4rz3r0/foruster/releases). Active Pages con *Settings → Pages → rama `main`, carpeta `/docs`*.
...
| FAQ | [doc/en/FAQ.md](doc/en/FAQ.md) | [doc/es/FAQ.md](doc/es/FAQ.md) |
...
**Foruster** es **software propietario de código cerrado** en las entregas a licenciatarios o clientes. La documentación de este repositorio se ofrece como referencia; los componentes de terceros conservan sus licencias. Las condiciones aplicables al material de este repositorio están en **[LICENSE](LICENSE)**. No deduzca la licencia de un binario concreto solo a partir de este texto: consulte el aviso legal incluido con esa entrega.
